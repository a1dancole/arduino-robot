...
{
  private:
	CarConfig::DistanceUnitConfig &config;
  ...
  public:
	...
	DistanceUnit(CarConfig::DistanceUnitConfig &pConfig) : config(pConfig)
	{
	}
  ...
  private:
	...
	void setDirection(const int direction)
	{
		...
		{
			int delayInMS = Math::distance(_direction, adjustedDirection); // values between 0-180
